...
public final class ItemGroupBinding implements ViewBinding {
  ...
  private ItemGroupBinding(@NonNull LinearLayout rootView, @NonNull TextView groupNameTextView) {
  ...
  public static ItemGroupBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemGroupBinding((LinearLayout) rootView, groupNameTextView);
    }
